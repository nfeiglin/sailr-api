                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p class="lead">You've tried to purchase <a href="@if(isset($seller->username) && isset($product->id)) {{ URL::action('BuyController@create', [$seller->username, $product->id]) }} @else 'LINK TO PRODUCT' @endif"> {{ $product->title or 'PRODUCT TITLE' }}</a> but we're afraid there have been some issues.</p>
                                                    <p class="panel">
                                                    <h2>Error details</h2>
