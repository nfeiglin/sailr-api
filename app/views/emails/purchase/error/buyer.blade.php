                                        ...
                                        <table class="twelve columns">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p class="lead">You've tried to purchase <a href="{{ URL::action('BuyController@create', [$seller->username, $product->id]) }}"> {{ $product->title or 'PRODUCT TITLE' }}</a> but we're afraid there have been some issues.</p>
                                                    <p class="panel">
                                                    <h2>Error details</h2>
